...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '202203291015_ARTMEDIA_SITE_31f54da1513d00932909_20220329131522_archive.zip';
	const ARCHIVE_SIZE		 = '55676606';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '31f54da-29131522';
    const SECONDARY_PACKAGE_HASH = '5f81797-29131522';
	const VERSION			 = '1.4.4';
