...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '202202170702_ARTMEDIA_SITE_8b7efbd94ef98e4f1370_20220217100252_archive.zip';
	const ARCHIVE_SIZE		 = '35985750';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '8b7efbd-17100252';
    const SECONDARY_PACKAGE_HASH = '86d5d53-17100252';
	const VERSION			 = '1.4.4';
