...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '202202220702_ARTMEDIA_SITE_f6b4cd0aaefe8ccd6339_20220222180128_archive.zip';
	const ARCHIVE_SIZE		 = '49732241';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'f6b4cd0-22180128';
    const SECONDARY_PACKAGE_HASH = 'c17e10b-22180128';
	const VERSION			 = '1.4.4';
